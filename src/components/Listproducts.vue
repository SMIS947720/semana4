   ...
   <div id="root">   
      <div class="container">
        <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
         ...
         <p v-if="itemsExist()"></p>
         <div class="footer">
           <label v-thml="message"></label>
         </div>
         
      </div>
     <a card-item: cartItems="cartItems" :itemCount="itemCount"/>
    </div>
</template>
   ...
   methods:{
      itemsExist: function(){
         if(this.cartItems.length>0){
            ...
            this.message="<h5 class='alert alert-danger'>cart empyt</h5>"
         }
